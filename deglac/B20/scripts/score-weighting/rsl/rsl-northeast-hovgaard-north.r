...
print("rsl-northeast-hovgaard-north.r")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-hovgaard-north.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-hovgaard-north.txt",sep="")
