...
print("rsl-northeast-sanddalen-offshore.r")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-sanddalen-offshore.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-sanddalen-offshore.txt",sep="")
