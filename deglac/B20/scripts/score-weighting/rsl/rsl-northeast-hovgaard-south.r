...
print("rsl-northeast-hovgaard-south.r")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-hovgaard-south.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-hovgaard-south.txt",sep="")
