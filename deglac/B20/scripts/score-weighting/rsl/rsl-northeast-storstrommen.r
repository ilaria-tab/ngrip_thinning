...
print("rsl-northeast-storstrommen.r")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-storstrommen.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-storstrommen.txt",sep="")
