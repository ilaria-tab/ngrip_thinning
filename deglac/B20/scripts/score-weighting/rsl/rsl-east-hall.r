...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-east-hall.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-east-hall.txt",sep="")
