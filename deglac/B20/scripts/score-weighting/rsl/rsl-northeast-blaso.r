...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-blaso.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-blaso.txt",sep="")
