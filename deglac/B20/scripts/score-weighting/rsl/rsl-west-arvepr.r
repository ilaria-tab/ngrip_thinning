...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-west-arvepr.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-west-arvepr.txt",sep="")
