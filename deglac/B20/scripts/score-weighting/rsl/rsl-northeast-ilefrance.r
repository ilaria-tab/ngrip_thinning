...
print("rsl-northeast-ilefrance.r")
...
# North East Bennike & Weidick 2001 (Ile de France)
loc=findij(77.83,-17.67)
t.min=c(-5580,-9260)
t.max=c(-5310,-9010)
rsl=c(21,52)
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-ilefrance.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-ilefrance.txt",sep="")
