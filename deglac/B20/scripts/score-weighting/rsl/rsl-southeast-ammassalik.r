...
print("rsl-southeast-ammassalik")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-southeast-ammassalik.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-southeast-ammassalik.txt",sep="")
