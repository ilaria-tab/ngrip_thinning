...
loc=findij(78.116667,-20.3)
t.min=c(-5600,-7510,-2850,-6170,-8160,-8110)
t.max=c(-5490,-7430,-2740,-5760,-7970,-7960)
rsl=c(12,30,2,10,40,17)
...
plot.out=paste(work.fldr,"/Figures/rsl/rsl-northeast-sanddalen-offshore.png", sep="")
png(plot.out, width = 5, height = 5, units = "in", res=100)
#dev.new()
plot(NULL, xlim=xlim, ylim=ylim, ylab="RSL (m)", xlab="Time (yr)", main="Northeast - Sanddalen Offshore (Bennike & Weidick 2001)")
...
work.fldr=paste("/home/titan/gwgk/gwgk005h/work/ngrip/v1.801/8km/lhs/B18/test45_deglac")
mean.rsl=read.table(paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-sanddalen-offshore.txt",sep=""), skip=1)
mean.rsl.b18=unlist(mean.rsl, use.names=FALSE)
sd.rsl=read.table(paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-sanddalen-offshore.txt",sep=""), skip=1)
