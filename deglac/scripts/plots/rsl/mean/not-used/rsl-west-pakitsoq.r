...
# West Pakitsoq (Long 2006)
loc=findij(69.491228, -50.747455)
t.min=c(-7581,-7429,-7262)
t.max=c(-7270,-7319,-6680)
rsl=c(NA,31.97,NA)
rsl.err=c(NA,1,NA)
...
plot.out=paste(work.fldr,"/Figures/rsl/rsl-west-pakitsoq.png", sep="")
png(plot.out, width = 5, height = 5, units = "in", res=100)
#dev.new()
plot(NULL, xlim=xlim, ylim=ylim, ylab="RSL (m)", xlab="Time (yr)", main="WEST - Pakitsoq (Long 2006)")
...
work.fldr=paste("/home/titan/gwgk/gwgk005h/work/ngrip/v1.801/8km/lhs/B18/test45_deglac")
mean.rsl=read.table(paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-west-pakitsoq.txt",sep=""), skip=1)
mean.rsl.b18=unlist(mean.rsl, use.names=FALSE)
sd.rsl=read.table(paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-west-pakitsoq.txt",sep=""), skip=1)
