...
loc=findij(79.75,-18.8)
t.min=c(-6290,-7990,-9540,-8550,-9860,-5460,-5450,-8960,-280)
t.max=c(-6040,-7850,-9460,-8410,-9550,-5310,-5290,-8600,0)
rsl=c(20,45,59,21,53,24,24,52,NA)
...
plot.out=paste(work.fldr,"/Figures/rsl/rsl-northeast-hovgaard-south.png", sep="")
png(plot.out, width = 5, height = 5, units = "in", res=100)
#dev.new()
plot(NULL, xlim=xlim, ylim=ylim, ylab="RSL (m)", xlab="Time (yr)", main="Northeast - Hovgaard Oer S (Bennike&Weidick 2001)")
...
work.fldr=paste("/home/titan/gwgk/gwgk005h/work/ngrip/v1.801/8km/lhs/B18/test45_deglac")
mean.rsl=read.table(paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-hovgaard-south.txt",sep=""), skip=1)
mean.rsl.b18=unlist(mean.rsl, use.names=FALSE)
sd.rsl=read.table(paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-hovgaard-south.txt",sep=""), skip=1)
