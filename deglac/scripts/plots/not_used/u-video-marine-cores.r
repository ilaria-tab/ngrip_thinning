...
j=1
for(i in 1:75){
  plot.out=paste(work.fldr,"/Figures/video/u/u-video-marine-cores",i,".png", sep="")
  ...
  points(xc[ps100.i],yc[ps100.j],col="black",bg="#3a86ff",pch=21, cex=1.2)
  points(xc[g92.i],yc[g92.j],col="black",bg="#8338ec",pch=24, cex=1.2)
  points(xc[g39.i],yc[g39.j],col="black",bg="#ff006e",pch=25, cex=1.2)
