...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-north-north-east.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-north-north-east.txt",sep="")
