...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-east-pedersen.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-east-pedersen.txt",sep="")
