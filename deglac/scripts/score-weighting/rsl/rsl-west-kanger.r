...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-west-kanger.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-west-kanger.txt",sep="")
