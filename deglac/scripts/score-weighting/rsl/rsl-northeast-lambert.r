...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-lambert.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-lambert.txt",sep="")
