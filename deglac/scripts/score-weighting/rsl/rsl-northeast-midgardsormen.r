...
print("rsl-northeast-midgardsormen.r")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/mean-rsl-northeast-midgardsormen.txt",sep="")
...
file.out=paste(work.fldr,"/scripts/score-weighting/rsl/sd-rsl-northeast-midgardsormen.txt",sep="")
